...
```
Yep, the median temperature of all the seasons generally increases in time. Here is the plot with full data for reference:
```{r echo=FALSE}
temp_season %>% 
...
temp_season %>%
  ...
  labs(title = "Values of slopes betas of fitted linear model",
       subtitle = "The trend of median temperatures imcrement of winter and \nspring is the highest, while autumn is the lowest")
